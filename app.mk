...
APP_DOCKER_IMAGE=$(shell echo $(APP_NAME) |awk -F '@' '{print "kratos-dtm-examples/" $$0 ":0.1.0"}')
...
openapi:
	@cd ../../../ && \
	buf generate --path protos/shop/service/v1 --template buf.shop.openapi.gen.yaml
